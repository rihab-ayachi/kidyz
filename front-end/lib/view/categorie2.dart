...
class Categorie2 extends StatefulWidget {
  Categorie2({Key? key}) : super(key: key);

  @override
  State<Categorie2> createState() => _Categorie2State();
}

class _Categorie2State extends State<Categorie2> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Column(children: [
          ...
          // ListView(children: [
          ListTile(
              title: Text("Poussetes"),
              trailing: Icon(Icons.play_arrow_rounded)),
          Divider(color: Colors.black38, height: 1, thickness: 1),
          ListTile(
              title: Text("Sièges bébé"),
              trailing: Icon(Icons.play_arrow_rounded)),
          Divider(color: Colors.black38, height: 1, thickness: 1),
          ListTile(
              title: Text("Chaise haute"),
              trailing: Icon(Icons.play_arrow_rounded)),
          Divider(color: Colors.black38, height: 1, thickness: 1),
          ListTile(
              title: Text(" Lit"), trailing: Icon(Icons.play_arrow_rounded))
        ]
            // .separated(
